document.addEventListener('DOMContentLoaded', function() {
  ...
  Tutorial.show({
    ...
    title: 'LE MOT JUSTE',
    subtitle: 'ÉPREUVE 3',
    description: 'Complète les phrases avec le vocabulaire technique des professionnels.',
    steps: [
      { icon: '📖', text: 'Lis la phrase incomplète qui apparaît au centre.' },
      { icon: '🤔', text: 'Trouve le terme technique qui manque.' },
      { icon: '👆', text: 'Clique sur le bon mot parmi les choix proposés.' },
      { icon: '🎯', text: 'Réponds correctement à au moins 3 phrases sur 5 !' }
    ],
  ...
  function initGame() {
    var allQuestions = [
      { before: "L'esthéticienne réalise des soins du", answer: "visage", after: "et du corps pour embellir la peau.", choices: ["visage", "moteur", "jardin", "réseau"] },
      { before: "Le fleuriste compose des", answer: "bouquets", after: "adaptés à chaque occasion et saison.", choices: ["bouquets", "circuits", "rapports", "plâtres"] },
      { before: "La prothésiste ongulaire pose du gel ou de la", answer: "résine", after: "sur les ongles de ses clientes.", choices: ["résine", "colle", "peinture", "mousse"] },
      { before: "Le coiffeur utilise des", answer: "ciseaux", after: "et un séchoir pour réaliser une coupe.", choices: ["ciseaux", "pinceaux", "scalpels", "tournevis"] },
      { before: "Le fleuriste événementiel décore les salles de", answer: "réception", after: "avec des compositions florales.", choices: ["réception", "sport", "classe", "chirurgie"] },
      { before: "En esthétique, le soin du visage commence par un", answer: "démaquillage", after: "pour nettoyer la peau en profondeur.", choices: ["démaquillage", "bandage", "ponçage", "lavage auto"] },
      { before: "Le fleuriste doit conserver ses fleurs dans un endroit", answer: "frais", after: "pour prolonger leur durée de vie.", choices: ["frais", "chaud", "sombre", "bruyant"] },
      { before: "Le CAP Esthétique permet de travailler en", answer: "institut", after: "de beauté, en spa ou à domicile.", choices: ["institut", "usine", "tribunal", "garage"] },
      { before: "La maquilleuse professionnelle travaille souvent dans le milieu du", answer: "spectacle", after: "pour les défilés, films et shootings.", choices: ["spectacle", "bâtiment", "transport", "jardinage"] },
      { before: "Le fleuriste utilise un", answer: "sécateur", after: "pour couper les tiges des fleurs.", choices: ["sécateur", "marteau", "stéthoscope", "scanner"] }
    ];
